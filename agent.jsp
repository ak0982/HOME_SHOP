...
body {
    background: url('loginimg2.jpg') no-repeat;
...
<h1>WELCOME AGENT</h1>
  ...
  <div class="wrapper">
    <form class="form-signin" action="agent_login_veri.jsp" method="post">       
      <h2 class="form-signin-heading">Please login</h2>
      <input type="text" class="form-control" name="agentid" placeholder="Agent id" required="" autofocus="" />
