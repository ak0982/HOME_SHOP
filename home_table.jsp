...
<body>
		...
		<h1><span class="blue">&lt;</span>HOME TABLE<span class="blue">&gt;</span> <span class="yellow">HOME SHOP 20</pan></h1>
...
<div id="buttons">
  ...
  <a href="login.jsp" class="btn darkblueb">Login</a>
</div>
<div id="buttons">
	...
	while(rs.next())
	{
		...
		<%
				...
				if(rs.getString(10).equals("AVAILABLE"))
				{
					...
					<td><a href="redirect.jsp" target="_blank"><h1 class="green">PURCHASE</h1></a></td>
